...
#MAIN_LABELS = [
 #   "office", "floor", "table", "screen", "keyboard", "mouse", "speaker", "lamp", "plant", "shelf"
#]
MAIN_LABELS = [
    "Show me a chair without a backrest"
]
#ORDER_FOR_READABILITY = ["table", "chair", "monitor", "keyboard", "mouse", "speaker", "lamp", "plant", "shelf", "floor"]
ORDER_FOR_READABILITY = ["Show me a chair without a backrest."]
...
def describe_scene(result, image_size_hw, score_thresh=0.05, iou_thresh=0.7
    ...
    core = []
    for k in ORDER_FOR_READABILITY:
        if k in per_cls:
            n = per_cls[k]["count"]
...
def main():
    ...
    path = "/home/user1/OWL-ViT/images/1.png"

    image = Image.open(path).convert("RGB")

    # Prompts 
    text_labels = [MAIN_LABELS]
